...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/RestAPIDemo` directory. You need to make sure you change the `repository` variable in your `chart/RestAPIDemo/values.yaml` file points to the docker image containing your runnable application.
